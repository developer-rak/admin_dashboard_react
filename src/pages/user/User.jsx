         ...
         <div className="userShow">
            ...
            <div className="userShowBottom">
               ...
               <div className="userShowInfo">
                  ...
                  <span className="userShwoInfoTitle">annabeck99</span>
               </div>
               <div className="userShowInfo">
                  <CalendarToday className='userShowIcon' />
                  <span className="userShwoInfoTitle">04.04.1999</span>
               </div>
               <span className="userShowTitle">Contact Details</span>
               <div className="userShowInfo">
                  <PhoneAndroid className='userShowIcon' />
                  <span className="userShwoInfoTitle">+ 92 311 0000000</span>
               </div>
               <div className="userShowInfo">
                  <MailOutline className='userShowIcon' />
                  <span className="userShwoInfoTitle">annabeck99@gmail.com</span>
               </div>
               <div className="userShowInfo">
                  <LocationSearching className='userShowIcon' />
                  <span className="userShwoInfoTitle">Shikarpur, Sindh</span>
               </div>
            </div>
         </div>
